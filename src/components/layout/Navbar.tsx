...
import { PenLine, Menu, X, BookMarked, LogOut, User, LayoutDashboard, Bell, Sun, Moon, Shield, Crown, MessageSquare } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="hidden md:flex items-center gap-1.5">
            <LangSwitcher />
            <button onClick={toggle} className="p-2 rounded-full text-[var(--fg-muted)] hover:text-[var(--fg)] hover:bg-[var(--bg-subtle)] transition-all">
            ...
            {user ? (
              <>
                ...
                <Link href="/messages" onClick={()=>setUnreadDMs(0)} className="relative p-2 rounded-full text-[var(--fg-muted)] hover:text-[var(--fg)] hover:bg-[var(--bg-subtle)] transition-all">
