    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8">
        {[
          ...
          { title: '5. Payments and Refunds', body: 'Payments for premium subscriptions are processed via Paddle. As our products are digital digital goods, all sales are final and non-refundable once access is granted. Users can cancel their subscriptions at any time to prevent future billing.' },
          { title: '6. Termination', body: 'Accounts violating these terms may be suspended or deleted without prior notice. You may appeal via our contact address.' },
          { title: '7. Disclaimer', body: 'InkStory is not responsible for user-generated content. The platform is provided "as is" without guarantee of uninterrupted service.' },
          { title: '8. Changes', body: 'These terms may be updated periodically. Significant changes will be communicated to your registered email.' },
          { title: '9. Contact', body: 'For questions and support: support@inkstory.com.tr. Business location: Kayseri, Turkiye.' },
        ].map(({ title, body }) => (
          <div key={title}>
